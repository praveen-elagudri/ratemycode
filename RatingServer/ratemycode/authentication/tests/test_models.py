...
from ratemycode.authentication.models import Profile
from ratemycode.activities.models import Notification
...
class TestModels(TestCase):
    ...
    def setUp(self):
        ...
        self.profile.url = 'tryratemycode.vitorfs.com'
    ...
    def test_return_url(self):
        self.assertEqual(self.profile.get_url(),
                         'http://tryratemycode.vitorfs.com')
